    ...
    <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-12">
      ...
      <div className="mb-10 text-center">
        ...
        <p className="mx-auto mt-3 max-w-2xl text-sm sm:text-base text-gray-600 dark:text-gray-300 leading-relaxed">
          Improve typing speed and reading comprehension simultaneously. Choose a story or technical engineering module below to start an interactive touch typing session.
        </p>
      </div>
